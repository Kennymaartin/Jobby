...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="relative z-20 border-b bg-gradient-to-r from-[#8942FE] to-[#4393FD]">
        <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
          <div className="flex h-20 items-center justify-between">
            ...
            {navbarOpen ? <MenuOverlay links={links} onClose={()=> setNavbarOpen(false)}/> : null}
        </div>
      </nav>
    </>
  );
